 ...
 * Guest unit: FAX-N — the trickster. A grinning red
 ...
 *   7.2 FAX-N appears (theatrical, unreliable)
...
const Chapter7 = (() => {
    ...
    <div class="puzzle-modal hidden" id="vexModal">
      <div class="puzzle-card vex-card">
        ...
        <div class="puzzle-header">
          <p class="puzzle-label sys-text">VEXIERSCHLOSS // FAX-N</p>
  ...
  function scene_7_1_arrival() {
    ...
    GameEngine.dialogue.load([
      ...
      { speaker:'R-3MI',  text:'„FAX-N. Er hält die ganze Anlage für seine Bühne — und uns für sein Publikum."' },
  ...
  function scene_7_2_faxn() {
    ...
    CH.showGuest(true);
    GameEngine.dialogue.load([
      { speaker:'FAX-N', text:'„HA! Gäste! Echte, lebendige Gäste! …oder seid ihr auch nur ein Trick? Egal. WILLKOMMEN auf meiner Bühne!"' },
  ...
  const C1 = {
    who: {
      ...
      lines:[
        { speaker:'FAX-N', text:'„FAX-N! Der Erste. IMMER der Erste. Wo ein Schloss aufgeht, war ich schon da und wieder weg, bevor du »Vexier« sagen kannst."' },
        ...
        { speaker:'FAX-N', text:'„Erster zu sein ist nur halb so schön, wenn keiner Zweiter wird. …aber pssst. Das stand nicht im Drehbuch."' },
      ],
    },
    place: {
      key:'place', label:'[Was ist dieser Ort?]', seen:false,
      lines:[
        { speaker:'FAX-N', text:'„Eine Bühne! Jeder Hebel eine Pointe, jede Tür ein Reinfall. Fass bloß nichts an, was offensichtlich aussieht — das Offensichtliche ist IMMER die Falle."' },
    ...
    trick: {
      ...
      lines:[
        { speaker:'FAX-N', text:'„Weil die Wahrheit, die man sich erarbeitet, länger bleibt als die, die man geschenkt kriegt. …oder weil’s einfach Spaß macht. Such dir was aus."' },
        ...
        { speaker:'FAX-N', text:'„Ich nehm’s zurück! Streicht das! Vergesst, dass ich je was Kluges gesagt hab!"' },
      ],
    },
  };
  ...
  function scene_7_4_explore() {
    GameEngine.dialogue.load([
      { speaker:'FAX-N', text:'„Schau dich ruhig um! Fass alles an! Oder nichts! Eins von beidem ist klug. Viel Glück beim Raten, hähä."' },
  ...
  function clickExplore(key) {
    ...
    if (key === 'lock') {
      if (!S.solved) {
        GameEngine.dialogue.load([
          ...
          { speaker:'FAX-N',  text:'„AH! Das Herzstück meiner Bühne! Vier Siegel, sechs Symbole, acht Versuche. Knack es — wenn du dich traust, Schätzchen."' },
        ], openVex);
      } else {
        GameEngine.dialogue.load([{ speaker:'FAX-N', text:'„Schon offen. Mit reiner Logik. Ich bin immer noch ein bisschen beleidigt."' }]);
      }
      return;
    }
    ...
    if (key === 'lever') {
      const bits = [
        [{ speaker:'SYSTEM', text:'Du ziehst am Hebel. Er kommt dir komplett entgegen — er war nie an irgendetwas befestigt.' },
         { speaker:'FAX-N',  text:'„HÄHÄ! Klassiker. Den bau ich in jeden Sektor. Funktioniert IMMER."' }],
        [{ speaker:'FAX-N',  text:'„Nochmal? Der ist immer noch an nichts angeschlossen. Aus Prinzip."' }],
      ];
    ...
    if (key === 'painting') {
      GameEngine.dialogue.load([
        ...
        { speaker:'FAX-N',  text:'„Tsss. Spielverderber. Aber… ja. Schön, oder? Drei Wochen gemalt."' },
      ]);
      return;
    }
    ...
    if (key === 'book') {
      if (!S.sigFound) {
        ...
        GameEngine.dialogue.load([
          ...
          { speaker:'FAX-N',  text:'„…die Seite. Die hab ich nicht geschrieben. Die ist einfach… angekommen. Eines Tages. Lies sie. Ich kann’s nicht mehr."' },
        ], () => {
          ...
          GameEngine.dialogue.load([
            ...
            { speaker:'FAX-N', text:'„Zum ersten Mal seit langer Zeit hab ich keinen Witz parat. …weitergehen. Schnell."' },
          ]);
        });
      } else {
        GameEngine.dialogue.load([{ speaker:'FAX-N', text:'„Die eine ehrliche Seite. Mehr Wahrheit hab ich nicht im Haus."' }]);
      }
      return;
    }
  }
  ...
  function openVex() {
    ...
    CH.initHints({
      ...
      empty: {
        ...
        guest: { speaker:'FAX-N', text:'„Aus! Schluss! Keine Tipps mehr! …das war auch wieder gelogen, aber diesmal stimmt’s."' },
      },
    });
    GameEngine.dialogue.load([
      { speaker:'SYSTEM', text:'VEXIERSCHLOSS // VIER SIEGEL · SECHS SYMBOLE · ACHT VERSUCHE.' },
      { speaker:'FAX-N',  text:'„Tipp deine vier Siegel, druck auf PRÜFEN, und ich sag dir — fast ehrlich — wie nah du dran bist. Die Punkte lügen nie. Ich schon. Viel Spaß!"' },
    ], () => {
  ...
  function vexSubmit() {
    ...
    if (VX.tries >= BUDGET) {
      setStatus('Versuche aufgebraucht. FAX-N mischt neu — und grinst.', 'error');
      ...
      CH.withModalDialogue([
        { speaker:'FAX-N', text:'„HÄHÄÄ! Aufgebraucht! Keine Sorge, Schätzchen — ich misch neu, und wir spielen NOCHMAL. Ich hab ja Zeit. Unendlich viel."' },
  ...
  function solveVex() {
    ...
    GameEngine.dialogue.load([
      ...
      { speaker:'FAX-N',  text:'„Pssst. Wenn das rauskommt, ist mein Ruf ruiniert. …geh weiter. Sektor acht. Aber pass auf."' },
      ...
      { speaker:'FAX-N',  text:'„Er lacht nie. Nicht, weil er traurig ist. Sondern weil er etwas WEISS. …viel Glück. Wirklich."' },
    ], () => CH.complete());
  }
